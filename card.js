    ...
    export let MeszarosCard = new tanarCards("Mészaros","vérszomjas","","summon","Meszaros", "Húzd fel a legfelső kártyát a paklidból!", 2, 5, Meszaros, 3, 3, "character", MeszarosGacha, "MeszarosCard", MeszarosA, "Médiatanár. A diákok gyakran jobban tudják az anyagot.", []);
    ...
    export let KinyoCard = new tanarCards("Kinyó","veszett","", "summon","Kinyo","Egy szabadon választott kártyába 3-mat sebez.", 9, 6, Kinyo, 3, 6, "character", GachaPH, "KinyoCard", KinyoA, "Megrendeli a ságváris merch-öt(?)", []);
