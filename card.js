    ...
    //#region TANÁROK
    export let BizsoCard = new tanarCards("Bizsó","lelkiismeretes","","summon","EmptyAbility", "Ha ez a kártya <b>elkárhozik</b>, a <b>kör</b> fázistól függetlenül azonnal <b>véget ér</b>.", 8, 6, Bizso, 4, 4, "character", BizsoGacha, "BizsoCard", BizsoA, "Kedvence egy jó python feladat. Ha szépen kéred, kienged a hátsó kijáraton. Szexi apuka.", []); 
    ...
    export let KocsiAndiCard = new tanarCards("Kocsondi Andrea","lelkiismeretes","","summon","EmptyAbility", "Az <b>átfolyó sebzés</b> halálakor mindig 1.", 7, 11, KocsiAndi, 3, 5, "character", KocsiAndiGacha, "KocsiAndiCard", KocsiAndiA, "Senki se tudja, hogy pontosan mit csinál. A sárga könyvvel kapcsolatban őt keresd!", []);
    ...
    export let MeszarosCard = new tanarCards("Mészaros","vérszomjas","","summon","EmptyAbility", "Húzd fel a legfelső kártyát a paklidból!", 2, 4, Meszaros, 3, 2, "character", MeszarosGacha, "MeszarosCard", MeszarosA, "Médiatanár. A diákok gyakran jobban tudják az anyagot.", []);
    ...
    export let TomiCard = new tanarCards("Dr. Tamás","vérszomjas,veszett","kettős támadás,fürge támadás,robbanó támadás,életelszívás","summon","EmptyAbility", "Készít maga mellé egy másolatot, csak akkor derül ki, hogy melyik az igazi, ha megtámadják az egyiket. A másolat elnyeli az átfolyó sebzést.", 5, 5, Tomi, 6, 10, "character", TomiGacha, "TomiCard", TomiA, "Fogorvos és táncvilágbajnok. Unatkozott, ezért elment tanárnak.", ["kettős:0"]);
    ...
    export let KinyoCard = new tanarCards("Kinyó","veszett","", "summon","EmptyAbility","Egy szabadon választott kártyába 3-mat sebez.", 2, 1, Kinyo, 3, 2, "character", GachaPH, "KinyoCard", KinyoA, "Megrendeli a ságváris merch-öt(?)", []);
    export let LaciNeniCard = new tanarCards("Laci néni","lelkiismeretes","","summon","EmptyAbility", "Amíg a pályán van, a kőpakli csak mézeskalácsházakat tartalmaz.", 99, 99, LaciNeni, 3, 99, "character", GachaPH, "LaciNeniCard", LaciNeniA, "Qu'est-ce que les schtroumpfs", []);
    ...
    export let SzaszakCard = new tanarCards("Szaszi","lelkiismeretes,vérszomjas","életelszívás_1,tövisesbőr","summon","EmptyAbility", "Az összes táblán lévő kártya veszít 2 életerőpontot.", 99, 99, Szaszak, 5, 99, "character", GachaPH, "SzaszakCard", SzasziA, "Bács-Kiskun, Baranya, Békés, Borsod-Abaúj-Zemplén, Csongrád-Csanád, Fejér, Győr-Moson-Sopron, Hajdú-Bihar, Heves, Jász-Nagykun-Szolnok, Komárom-Esztergom, Nógrád, Pest, Somogy, Szabolcs-Szatmár-Bereg, Tolna, Vas, Veszprém, Zala", []);
    ...
    export let TritzCard = new tanarCards("Tritzy","vérszomjas","","summon","EmptyAbility", "A paklid 2 legalsó karakterkártyája a temedőbe kerül. ", 99, 99, Tritz, 4, 99, "character", GachaPH, "TritzCard", TritzyA, "😄   -->   😈", []);
