    ...
    export let felelesCard = new spellCards("felelés","EmptyAbility", "summon", "Sebezz 2-t egy szabadon választott táblán lévő kártyába! <b>'Diák'</b> kártyákba 3-mal többet sebez.",feleles,3,2,"spell",felelesGacha,"felelesCard",gachaPHAudio, "Készültél?")
    export let instantMerevedesCard = new spellCards("instant merevedés","EmptyAbility", "summon", "Egy szabadon választott táblán lévő kártya <b>'Kő'</b>-vé változik.",instantMerevedes,4,4,"spell",instantMerevedesGacha,"instantMerevedesCard",gachaPHAudio, "Az osztály előtt kell megszólalnod és még fel is áll!")
    export let jegkremCard = new spellCards("ingyen jégkrém az udvaron","EmptyAbility", "summon", "A térfeleden lévő összes <b>'tunya'</b> kártyáért +1mana.",jegkrem,4,0,"spell",jegkremGacha,"jegkremCard",gachaPHAudio, "Cukros víz Ukrajnából. Összehozza a diákokat.")
    export let lyukasoraCard = new spellCards("lyukasóra","EmptyAbility", "summon", "Gyógyít 3 életerőpontot, VAGY levesz minden gyengítő hatást egy szabadon választott térfeleden lévő célpontról.",lyukasora,3,2,"spell",lyukasoraGacha,"lyukasoraCard",gachaPHAudio, "45 perc nyugalom.")
    export let palacsintaFeszCard = new spellCards("palacsintafesztivál","EmptyAbility", "summon", "Az összes térfeleden lévő kártyát 2-vel gyógyítja.",palacsintaFesz,3,1,"spell",palacsintaFeszGacha,"palacsintaFeszCard",gachaPHAudio, "Nem lett csocsóasztal, de legalább jól szórakoztunk.")
    export let sportSzeletCard = new spellCards("sport szelet a futónapon","EmptyAbility", "summon", "+1mana.",sportSzelet,3,0,"spell",sportSzeletGacha,"sportSzeletCard",gachaPHAudio, "Bármikor lefutnék 2000 métert ilyen ajándékért.")
    ...
    export let ideAManaddalCard = new spellCards("ide a manáddal","EmptyAbility", "summon", "<b>Szívj el</b> 2 manát az ellenféltől!",ideAManaddal,3,2,"spell",ideAManaddalGacha,"ideAManaddalCard",gachaPHAudio, "Lopni amúgy nem szép dolog.")
    export let tuzgolyoCard = new spellCards("tűzgolyó","EmptyAbility", "summon", "Sebezz 4-et egy szabadon választott célpontba!",tuzgolyo,3,2,"spell",tuzgolyoGacha,"tuzgolyoCard",gachaPHAudio, "Kedvenc Pitbull számom")
    export let meteorCard = new spellCards("meteor","EmptyAbility", "summon", "Sebezz 5-öt egy szabadon választott táblán lévő ellenséges célpontba és vízszintes szomszédaiba egyaránt!",meteor,3,5,"spell",meteorGacha,"meteorCard",gachaPHAudio, "Ami fent csíp, az előbb-utóbb alul is fog.")
    ...
    export let sagvarizmusEjszakajaCard = new spellCards("Ságvárizmus Éjszakája","EmptyAbility", "summon", "Egy szabadon választott térfeleden lévő kártya atk-ját megduplázza.",sagvarizmusEjszakaja,3,2,"spell",sagvarizmusEjszakajaGacha,"sagvarizmusEjszakajaCard",gachaPHAudio, "Nem lehet alkoholt bevinni. Papíron.")
    ...
    export let saraToborzasCard = new spellCards("SÁRA toborzás","EmptyAbility", "summon", "Húzz fel 2 kártyát!",saratoborzas,3,1,"spell",saratoborzasGacha,"saraToborzasCard",gachaPHAudio, "A legügyesebbeket besorozzák. Egy fokkal jobb, mint a hadsereg.")
    export let saraSzurkolotaborCard = new spellCards("SÁRA szurkolótábor","EmptyAbility", "summon", "Minden kártyának a térfeleden +1atk és +1hp.",Te,3,2,"spell",GachaPHSpell,"saraSzurkolotaborCard",gachaPHAudio, "Versenyszellem garantált.")
    export let falanxCard = new spellCards("falanx","EmptyAbility", "summon", "Készíts a hátsó sorodban lévő entitások elé <b>'Köveket'</b>.",falanx,4,3,"spell",falanxGacha,"falanxCard",gachaPHAudio, "Nagy Sándor tiszteletére.")
    ...
    export let kalodaCard = new spellCards("kaloda a pincében","DrawOne","summon","<b>Némíts el</b> egy szabadon választott táblán lévő kártyát!",kaloda,3,2,"spell",kalodaGacha,"kalodaCard",gachaPHAudio, "Az agyi funkciók leállnak. Káros az egészségre.")
    export let javitoDolgozatCard = new spellCards("javító dolgozat","EmptyAbility", "summon", "Dobj el egy random kártyát a kezedből és húzz fel helyette 3 másikat!",javitoDolgozat,3,1,"spell",javitoDolgozatGacha,"javitoDolgozatCard",gachaPHAudio, "Hiszek a második esélyben.")
    export let mezeskalacsCard = new spellCards("mézeskalács","EmptyAbility", "summon", "Az összes térfeleden lévő <b>'Kő'</b> <b>'Mézeskalácsházzá'</b> változik.",mezeskalacs,3,2,"spell",mezeskalacsGacha,"mezeskalacsCard",gachaPHAudio, "Hasznos az, amit meg lehet enni vagy házat lehet belőle készíteni. -Kristóf filozófia szakkörről")
    ...
    export let alazatossagCard = new spellCards("alázatosság","EmptyAbility", "summon", "Egy szabadon választott táblán lévő kártya atk-ját változtasd 1-re.",alazatossag,3,2,"spell",alazatossagGacha,"alazatossagCard",gachaPHAudio, "Térdelj le, bébi!")
    ...
    export let MegaCharizardXLangjaCard = new spellCards("Mega Charizard X lángja","EmptyAbility", "summon", "Sebezz 8-at egy szabadon választott célpontba!",megacharizardxlangja,5,2,"spell",GachaPHSpell,"MegaCharizardXLangjaCard",gachaPHAudio, "")
    export let rakocziTurosCard = new spellCards("Rákóczi túrós","EmptyAbility", "summon", "Egy szabadon választott térfeleden lévő kártyának +2hp.",rakoczituros,5,1,"spell",GachaPHSpell,"rakocziturosCard",gachaPHAudio, "")
    export let banankenyerCard = new spellCards("banánkenyér","EmptyAbility", "summon", "Egy szabadon választott térfeleden lévő kártyának +2atk.",banankenyer,5,1,"spell",GachaPHSpell,"banankenyerCard",gachaPHAudio, "")
    export let csokitortaCard = new spellCards("csokitorta","EmptyAbility", "summon", "Egy szabadon választott térfeleden lévő kártyának <b>pajzsot</b> ad.",csokitorta,5,1,"spell",GachaPHSpell,"csokitortaCard",gachaPHAudio, "")
    export let dobostortaCard = new spellCards("dobostorta","EmptyAbility", "summon", "Egy szabadon választott térfeleden lévő kártyának <b>varázs-pajzsot</b> ad.",dobostorta,5,1,"spell",GachaPHSpell,"dobostortaCard",gachaPHAudio, "")
    export let piskotatekercsCard = new spellCards("piskótatekercs","EmptyAbility", "summon", "Egy szabadon választott térfeleden lévő kártya <b>metamorfozeál</b> (2).",piskotatekercs,5,1,"spell",GachaPHSpell,"piskotatekercsCard",gachaPHAudio, "A kedvencem.")
    export let magCard = new spellCards("mag","EmptyAbility", "summon", "Az összes <b>'humános'</b> kártya a térfeleden <b>metamorfozeál</b> (2).",mag,5,1,"spell",magGacha,"magCard",gachaPHAudio, "A lélek a személyiség magja. Vagy valami olyasmi...")
    ...
    export let ZalanCard = new diakCards("Zalán","veszett","kihívó", "onatk","EmptyAbility","<b>Idézés:</b> Készíts a kezedbe egy <b>'Palacsintafesztivál'</b> kártyát! <b>Passzív:</b> Ha támad, <b>'Dobi'</b>-nak a játék végéig +2atk és +2hp.", 3, 6, 6, Zalan, 5, 3, "character", ZalanGacha, "ZalanCard", ZalanA, "Mindenki kedvenc DÖK elnöke. Volt. Menő bőrdzseki!", [],["fiú", "diák", "reálos"]);
    ...
    export let AbigelCard = new diakCards("Abigél","lelkiismeretes","","summon","EmptyAbility", "<b>Idézés:</b> Az összes kezedben lévő kártyának +1atk és +1hp.", 2, 2, 2, Abigel, 3, 1, "character", AbigelGacha, "AbigelCard", gachaPHAudio, "Most vörös a hajam.", [],["lány", "diák", "reálos"]);
    export let BaloCard = new diakCards("Báló","veszett","kihívó","onturnstart","EmptyAbility", "<b>Passzív:</b> Minden kör elején készíts egy <b>'Nokedli 7/G-s'</b>-t egy szabadon választott üres mezőre a térfeleden!", 8, 13, 13, Balo, 4, 1, "character", BaloGacha, "BaloCard", gachaPHAudio, "Magas. Minden lánynak ő kell.", [],["fiú", "diák", "reálos"]);
    ...
    export let VendelCard = new diakCards("Vendel","vérszomjas","","onchardeath","EmptyAbility", "<b>Passzív:</b> Ha <b>elkárhozik</b> egy kártya a térfeleden, húzz fel egy kártyát!", 7, 9, 9, Vendel, 3, 6, "character", VendelGacha, "VendelCard", gachaPHAudio, "", [],["fiú", "diák", "öreg ságváris"]);
    export let NagyGyorgyCard = new diakCards("Nagy-György Balázs","vérszomjas","kihívó","summon","EmptyAbility", "<b>Idézés:</b> Az összes szomszédja <b>metamorfozeál</b>.", 2, 3, 3, Nagygyorgy, 3, 3, "character", NagygyorgyGacha, "NagyGyorgyCard", gachaPHAudio, "", [],["fiú", "diák", "reálos"]);
    export let SzakonyiCard = new diakCards("Szakonyi Marcell","","tövisesbőr","summon","EmptyAbility", "<b>Passzív:</b> Ha <b>metamorfozeálnád</b>, metamorfózis helyett elkészíti a kártyát a térfeledre.", 4, 7, 7, Szakonyi, 3, 4, "character", SzakonyiGacha, "SzakonyiCard", gachaPHAudio, "", [],["fiú", "diák", "reálos"]);
    export let RebeccaCard = new diakCards("Manccinelli Rebecca","veszett","tövisesbőr","boardcon","EmptyAbility", "<b>Passzív:</b> A többi térfeleden lévő <b>'DÖK-ös'</b> kártyának +2atk.", 2, 3, 3, Rebecca, 3, 2, "character", RebeccaGacha, "RebeccaCard", gachaPHAudio, "", [],["lány", "dök", "diák", "humános"]);
    export let TanacsBotondCard = new diakCards("Tanács Botond","tunya","","boardcon","EmptyAbility", "<b>Passzív:</b> A többi térfeleden lévő <b>'DÖK-ös'</b> kártyának +3hp.", 5, 5, 5, Tanacsbotond, 3, 3, "character", TanacsbotondGacha, "TanacsBotondCard", gachaPHAudio, "", [],["fiú", "dök", "diák", "reálos"]);
    export let ZsirosPeterCard = new diakCards("Zsíros Péter","lelkiismeretes","kihívó","boardcon","EmptyAbility", "<b>Idézés:</b> Minden másik térfeleden lévő <b>'DÖK-ös'</b> kártyáért +2hp.", 2, 11, 11, Zsirospeter, 3, 4, "character", ZsirospeterGacha, "ZsirosPeterCard", gachaPHAudio, "", [],["fiú", "dök", "diák"]);
    export let GalLeventeCard = new diakCards("Gál Levente","veszett","kettős támadás","boardcon","EmptyAbility", "<b>Passzív:</b> A többi térfeleden lévő <b>'DÖK-ös'</b> kártya <b>'veszetté'</b> változik.", 4, 4, 4, Gallevente, 4, 4, "character", GalleventeGacha, "GalLeventeCard", gachaPHAudio, "", [],["fiú", "dök", "diák", "reálos", "sportos"]);
    export let BorosKingaCard = new diakCards("Boros Kinga","lelkiismeretes","tövisesbőr","boardcon","EmptyAbility", "<b>Passzív:</b> A többi térfeleden lévő <b>'DÖK-ös'</b> kártyának +4atk.", 5, 13, 13, BorosKinga, 3, 5, "character", BorosKingaGacha, "BorosKingaCard", gachaPHAudio, "", [],["lány", "dök", "diák", "reálos"]);
    export let MolnarRekaCard = new diakCards("Molnár Réka","lelkiismeretes","tövisesbőr","boardcon","EmptyAbility", "<b>Passzív:</b> A többi térfeleden lévő <b>'DÖK-ös'</b> kártyának +5atk.", 6, 14, 14, Molnarreka, 3, 6, "character", MolnarrekaGacha, "MolnarRekaCard", gachaPHAudio, "", [],["lány", "dök", "diák", "reálos"]);
    export let KaszaDomonkosCard = new diakCards("Kasza Domonkos","veszett","","boardcon","EmptyAbility", "<b>Passzív:</b> A többi térfeleden lévő <b>'DÖK-ös'</b> kártyának <b>'robbanó támadást'</b> ad.", 7, 5, 5, Kaszadomonkos, 3, 5, "character", KaszadomonkosGacha, "KaszaDomonkosCard", gachaPHAudio, "", [],["fiú", "dök", "diák", "humános"]);
    export let VighAndrisCard = new diakCards("Vígh Andris","veszett","kihívó","summon","EmptyAbility", "<b>Passzív:</b> Csak az ellenfél fázisában +3atk.", 2, 5, 5, Vighandris, 4, 3, "character", VighandrisGacha, "VighAndrisCard", gachaPHAudio, "", [],["fiú", "diák", "humános", "sportos"]);
    export let MiklosCard = new diakCards("Miklós","tunya","fürge támadás","summon","EmptyAbility", "<b>Idézés:</b> Készít 2 <b>'Ságvári Endre szobor'</b> kártyát a térfeledre.", 2, 1, 1, Miklos, 3, 4, "character", MiklosGacha, "MiklosCard", gachaPHAudio, "", [],["fiú", "diák", "reálos"]);
    export let GittaCard = new diakCards("Gitta","vérszomjas","fürge támadás","summon","EmptyAbility", "<b>Passzív:</b> Ha kijátszol egy varázsige kártyát, +2atk.", 1, 5, 5, Gitta, 3, 2, "character", GittaGacha, "GittaCard", gachaPHAudio, "", [],["lány", "diák"]);
    export let NagyBenedekCard = new diakCards("Nagy Benedek","veszett","tövisesbőr","summon","EmptyAbility", "<b>Idézés:</b> Egy szabadon választott térfeleden lévő kártyának +2atk.", 1, 2, 2, Nagybenedek, 3, 1, "character", NagybenedekGacha, "NagyBenedekCard", gachaPHAudio, "", [],["fiú", "diák", "humános"]);
    export let VorosBalintCard = new diakCards("Vörös Bálint","vérszomjas","életelszívás","summon","EmptyAbility", "<b>Passzív:</b> Ha kijátszol egy varázsige kártyát, készít egy random 2 manába kerülő kártyát a térfeledre.", 5, 4, 4, Vorosbalint, 4, 5, "character", VorosbalintGacha, "VorosBalintCard", gachaPHAudio, "", [],["fiú", "diák", "humános", "sportos"]);
    ...
    export let AproNoCard = new extraCards("Apró Fehér Nő","veszett","fürge támadás","summon","EmptyAbility", "<b>Passzív:</b> Ha 2 (erős fehér) <b>'fiú'</b> a szomszédja, +3atk és +3hp.", 2, 3, 3, AproNo, 4, 2, "character", AproNoGacha, "AproNoCard", AproNoA, "Egy apró fehér nő. Gyenge, a férfiak alatt áll, nincsennek jogai.", [],["lány"]);
    ...
    export let SzerencsesZsoblinCard = new extraCards("Szerencsés Zsoblin","tunya","","summon","EmptyAbility", "<b>Passzív:</b> A <b>szerencséd</b> 30%-kal megnő.", 5, 5, 5, Zsoblin, 3, 3, "character", ZsoblinGacha, "SzerencsesZsoblinCard", gachaPHAudio, "", [],["fiú", "tanár", "reálos"]);
    ...
    export let SarkanytojasCard = new extraCards("Sárkánytojás","","","summon","EmptyAbility", "<b>Idézés:</b> 2 kör után átváltozik <b>'Charmander'</b>-ré.", 0, 10, 10, Sarkanytojas, 4, 2, "character", SarkanytojasGacha, "SarkanytojasCard", gachaPHAudio, "", ["turnCount:0"],[]);
    ...
    export let BufesMoniCard = new extraCards("Büfés Móni","lelkiismeretes","","summon","EmptyAbility", "<b>Idézés:</b> Készít a térfeledre egy <b>'Büfé'</b> <b>építményt</b>.", 4, 6, 6, BufesMoni, 3, 3, "character", BufesMoniGacha, "BufesMoniCard", gachaPHAudio, "", [],["lány"]);
    export let ErzsikeCard = new extraCards("Erzsike","vérszomjas","kihívó, fürge támadás","summon","EmptyAbility", "<b>Idézés:</b> Készít a térfeledre egy <b>'Porta'</b> <b>építményt</b>.", 2, 8, 8, Erzsi, 3, 4, "character", ErzsiGacha, "ErzsikeCard", gachaPHAudio, "", [],["lány"]);
    //#endregion
    //#region extra extra
    ...
    export let DoloresCard = new extraCards("Dolores","vérszomjas","tövisesbőr","summon","EmptyAbility", "<b>Passzív:</b> Minden <b>'sportos'</b> kártyának a térfeleden <b>varázs-pajzsot</b> ad. A kör elején készít egy random <b>sütemény</b> varázsigét a kezedbe.", 6, 3, 3, Dolores, 3, 0, "character", GachaPH, "DoloresCard", gachaPHAudio, "", [],["lány"]);
    ...
    export let CharmanderCard = new extraCards("Charmander","lelkiismeretes","","summon","EmptyAbility", "<b>Idézés:</b> 2 kör után átváltozik <b>'Charmeleon'</b>-né. <b>Passzív:</b> Ha kijátszol egy varázsige kártyát, készít a kezedbe egy <b>'Charmander lángja'</b> kártyát.", 6, 7, 7, Charmander, 3, 4, "character", GachaPH, "CharmanderCard", gachaPHAudio, "", ["turnCount:0"],[]);
    export let CharmeleonCard = new extraCards("Charmeleon","","tövisesbőr","summon","EmptyAbility", "<b>Idézés:</b> 2 kör után átváltozik <b>'Charizard'</b>-dá. <b>Passzív:</b> Ha kijátszol egy varázsige kártyát, készít a kezedbe egy <b>'Charmeleon lángja'</b> kártyát.", 6, 11, 11, Charmeleon, 3, 6, "character", GachaPH, "CharmeleonCard", gachaPHAudio, "", ["turnCount:0"],[]);
    export let CharizardCard = new extraCards("Charizard","vérszomjas","töviesbőr","summon","EmptyAbility", "<b>Passzív:</b> Ha kijátszol egy varázsige kártyát, készít a kezedbe egy <b>'Charizard lángja'</b> kártyát. <b>Idézés:</b> 2 kör után átváltozik <b>' Mega Charizard X'</b>-szé.", 6, 12, 12, Charizard, 3, 7, "character", GachaPH, "CharizardCard", gachaPHAudio, "", ["turnCount:0"],[]);
    export let MegaCharizardXCard = new extraCards("Mega Charizard X","vérszomjas","tövisesbőr","summon","EmptyAbility", "<b>Passzív:</b> Ha kijátszol egy varázsige kártyát, készít a kezedbe egy <b>'Mega Charizard X lángja'</b> kártyát.", 8, 14, 14, Megacharizardx, 3, 10, "character", GachaPH, "MegaCharizardXCard", gachaPHAudio, "", [],[]);
    //#endregion
    //#endregion
    //#region   CONSTRUCTIONS
    export let TanariSzobaCard = new constructionCards("Tanári Szoba","EmptyAbility","summon","Minden térfeleden lévő <b>'tanár'</b> közvetlenül támadhatja az ellenfelet. <b>Megsemmisül</b>, ha: egy <b>'diák'</b> kártya a térfeledre kerül.",tanariszoba,3,0,"building",GachaPH,"TanariSzobaCard")
    export let BufeCard = new constructionCards("Büfé","EmptyAbility","summon","A kör végén minden első sorban lévő kártya a térfeleden gyógyul 1-gyel. <b>Megsemmisül</b>, ha: nincs kit gyógyítani.",bufe,3,0,"building",GachaPH,"BufeCard")
    export let PortaCard = new constructionCards("Porta","EmptyAbility","summon","Ha egy <b>'diák'</b> kártya a térfeleden <b>elkárhozik</b>, a kezedbe kerül vissza és 1-gyel kevesebb manába kerül (min 1). Ez az építmény csak akkor aktív, ha nincsen <b>'tanár'</b> kártya a térfeleden.",porta,3,0,"building",GachaPH,"PortaCard")
    //#endregion
    ...
    export let extraCardsArr = [AproNoCard,NokedliCard,JeffCard,TheRockCard,SzerencsesZsoblinCard,MikyxCard,SarkanytojasCard,ZozoCard,StrawberryCard,BufesMoniCard,ErzsikeCard]
