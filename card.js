    ...
    export let TheRockCard = new diakCards("Dwayne 'The Rock' Johnson","vérszomjas","","summon","EmptyAbility", "<b>Passzív:</b> Minden felé irányuló sebzés csökken 1-gyel.", 0, 10, 10, Therock, 4, 3, "character", TherockGacha, "TheRockCard", gachaPHAudio, "", [],["fiú", "sportos"]);
    export let SzerencsesZsoblinCard = new diakCards("Szerencsés Zsoblin","tunya","","summon","EmptyAbility", "<b>Passzív:</b> A <b>szerencséd</b> 30%-kal megnő.", 5, 5, 5, Zsoblin, 3, 3, "character", ZsoblinGacha, "SzerencsesZsoblinCard", gachaPHAudio, "", [],["fiú", "tanár", "reálos"]);
    ...
    export let SarkanytojasCard = new diakCards("Sárkánytojás","","","summon","EmptyAbility", "<b>Idézés:</b> 2 kör után átváltozik <b>'Charmander'</b>-ré.", 0, 10, 10, Sarkanytojas, 4, 2, "character", SarkanytojasGacha, "SarkanytojasCard", gachaPHAudio, "", ["turnCount:0"],[]);
    export let ZozoCard = new diakCards("Zozó","veszett","","summon","EmptyAbility", "<b>Passzív:</b> Ha <b>'Strawberry'</b> a térfeleden van vele, a kör végén +2atk és +1 hp.", 2, 2, 2, Zozo, 3, 1, "character", ZozoGacha, "ZozoCard", gachaPHAudio, "", [],["fiú"]);
    export let StrawberryCard = new diakCards("Strawberry","vérszomjas","","summon","EmptyAbility", "<b>Passzív:</b> Ha <b>'Zozó'</b> a térfeleden van vele, a kör végén +1atk és +2 hp.", 2, 2, 2, Starwberry, 3, 1, "character", StrawberryGacha, "StrawberryCard", gachaPHAudio, "", [],["lány"]);
    export let BufesMoniCard = new diakCards("Büfés Móni","lelkiismeretes","","summon","EmptyAbility", "<b>Idézés:</b> Készít a térfeledre egy <b>'Büfé'</b> <b>építményt</b>.", 4, 6, 6, BufesMoni, 3, 3, "character", BufesMoniGacha, "BufesMoniCard", gachaPHAudio, "", [],["lány"]);
    export let ErzsikeCard = new diakCards("Erzsike","vérszomjas","kihívó, fürge támadás","summon","EmptyAbility", "<b>Idézés:</b> Készít a térfeledre egy <b>'Porta'</b> <b>építményt</b>.", 2, 8, 8, Erzsi, 3, 4, "character", ErzsiGacha, "ErzsikeCard", gachaPHAudio, "", [],["lány"]);
    //#endregion
    //#region extra extra
    ...
    export let CsontvazCard = new diakCards("Bioszszertár csontváza","","","summon","EmptyAbility", "<b>Kijátszásig:</b> Ha a kezedben van, a kör végén +1atk és +1hp.", 1, 1, 1, Csontvaz, 3, 2, "character", GachaPH, "CsontvazCard", gachaPHAudio, "", [],["lány", "halott"]);
