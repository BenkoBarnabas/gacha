    ...
    import KutiHuman from "./lib/assets/collection/tanar/KutiHuman.png"
    import KutiReal from "./lib/assets/collection/tanar/KutiReal.png"
    import KutiSport from "./lib/assets/collection/tanar/KutiSport.png"
    ...
    export let NagyoraCard = new tanarCards("Nagy 'óra","veszett","kihívó","summon","EmptyAbility", "A <b>hátsó</b> sorod összes kártyája kap <b>2</b> hp-t.", 4, 10, Nagyora, 3, 4, "character", NagyoraGacha, "NagyoraCard", NagyoraA, "Télen is szoknyában jár. Számára a stílus az első.", []);
    ...
    export let TabiCard = new tanarCards("Tábi", "vérszomjas","fürge támadás","summon","EmptyAbility", "Minden <b>'tunya'</b> kártya <b>+2atk</b>.", 2, 4, Tabi, 3, 3, "character", TabiGacha, "TabiCard", TabiA, "Tesitanár és röplabdaedző. Epic gamer szabadidejében. Sose hagyja ki az alkalmat, hogy politizáljon.", []);
    export let BencusCard = new tanarCards("Illés Bence","tunya","","summon","EmptyAbility", "<b>Visszakerül</b> a játékos kezébe az a kártya, ami által <b>elkárhozott</b>.", 6, 6, Bencus, 4, 4, "character", BencusGacha, "BencusCard", BencusA, "Másodállásban professzionális diáktanya dolgozó.", []);
    export let DobiCard = new tanarCards("Dobi","veszett","kettős támadás","summon","EmptyAbility", "Az ellenfél összes <b>'diák'</b> kártyája <b>ledermed 1</b> körre. ", 6, 6, Dobi, 6, 10, "character", DobiGacha, "DobiCard", DobbyA, "Dob", ["kettős:0"]);
    export let IvanEvaCard = new tanarCards("Iván Éva","tunya","tövisesbőr","summon","EmptyAbility", "<b>Ledermed 1</b> körre minden kártya, amelyik <b>megtámadja</b>.", 2, 2, IvanEva, 3, 2, "character", IvanEvaGacha, "IvanEvaCard", IvanEvaA, "Average Edward Allen Poe fan, nem egy szakbarbár. Irigylésre méltó!", []);
    export let KocsiAndiCard = new tanarCards("Kocsondi Andrea","lelkiismeretes","","summon","KocsiAndi", "Az <b>átfolyó sebzés</b> halálakor mindig 1.", 7, 11, KocsiAndi, 3, 5, "character", KocsiAndiGacha, "KocsiAndiCard", KocsiAndiA, "Senki se tudja, hogy pontosan mit csinál. A sárga könyvvel kapcsolatban őt keresd!", []);
