    ...
    export let tanariErtekezletCard = new spellCards("tanári értekezlet","EmptyAbility", "summon", "Készíts egy <b>'Tanári szoba'</b> <b>építményt</b> a térfeledre!",tanariertekezlet,4,2,"spell",tanariertekezletGacha,"tanariErtekezletCard",gachaPHAudio, "")
    ...
    export let magCard = new spellCards("mag","EmptyAbility", "summon", "Az összes <b>'humános'</b> kártya a térfeleden <b>metamorfozeál</b> (2).",mag,5,1,"spell",magGacha,"magCard",gachaPHAudio, "")
    export let mindenBalazsCard = new spellCards("minden Balázs","EmptyAbility", "summon", "Minden térfeleden lévő <b>'Kő'</b> <b>'Balázskő'</b>-vé változik.",mindenbalazs,5,7,"spell",mindenbalazsGacha,"mindenBalazsCard",gachaPHAudio, "")
    export let felvilagosodasCard = new spellCards("felvilágosodás","EmptyAbility", "summon", "Az összes kártya a térfeleden <b>felébred</b>.",felvilagosodas,5,2,"spell",felvilagosodasGacha,"felvilagosodasCard",gachaPHAudio, "")
    export let terminusdogaCard = new spellCards("terminusdoga","EmptyAbility", "summon", "Az összes ellenséges <b>'reálos'</b> kártya a táblán <b>elkábul</b>.",terminusdoga,5,2,"spell",terminusdogaGacha,"terminusdogaCard",gachaPHAudio, "")
    export let secretCoverCard = new spellCards("Titkos Varázsige","summon","EmptyAbility", "Shh valami történni fog.", Te, 3, 0, "spell", GachaPHSpell, "secretCoverCard", gachaPHAudio, '');
    //#endregion
    ...
    export let BalazsCard = new diakCards("Balázs","vérszomjas","","summon","EmptyAbility", "<b>Passzív:</b> A térfeleden lévő <b>'Kövek'</b> vele támadnak. <b>Idézés:</b> Készíts egy <b>'Követ'</b> egy szabadon választott üres mezőre a térfeleden! Minden térfeleden lévő <b>'Kő'</b> atk-ját növeli 1-gyel.", 6, 9, 9, Balazs, 5, 6, "character", BalazsGacha, "BalazsCard", gachaPHAudio, "", [],["fiú", "diák", "reálos", "öreg ságváris"]);
    export let AbigelCard = new diakCards("Abigél","lelkiismeretes","","summon","EmptyAbility", "<b>Idézés:</b> Az összes kezedben lévő kártyának +1atk és +1hp.", 2, 2, 2, Abigel, 3, 1, "character", AbigelGacha, "AbigelCard", gachaPHAudio, "", [],["lány", "diák", "reálos"]);
    export let BaloCard = new diakCards("Báló","veszett","kihívó","onturnstart","EmptyAbility", "<b>Passzív:</b> Minden kör elején készíts egy <b>'Nokedli 7/G-s'</b>-t egy szabadon választott üres mezőre a térfeleden!", 8, 13, 13, Balo, 4, 1, "character", BaloGacha, "BaloCard", gachaPHAudio, "", [],["fiú", "diák", "reálos"]);
    export let ArpadCard = new diakCards("Árpád","lelkiismeretes","","summon","EmptyAbility", "<b>Elkárhozás:</b> '5 + a táblán lévő kártyák számának hatszorosa' értékű sebzést egyenlően eloszt az összes táblán lévő kártya között. A maradék sebzés közvetlenül az ellenfélbe megy. Ha teljesítetted <b>'Árpád'</b> jelenlétében mind az 5 <b>filozófiai próbát</b>, az összes sebzés közvetlenül az ellenfélbe megy. <b>Idézés:</b> A térfeledre készít egy <b>pajzsot</b>.", 10, 18, 18, Arpad, 3, 9, "character", ArpadGacha, "ArpadCard", gachaPHAudio, "", [],["fiú", "diák", "humános", "öreg ságváris"]);
    export let SzaszLeventeCard = new diakCards("Szász Levente","veszett","kihívó","summon","EmptyAbility", "<b>Idézés:</b> Az összes térfeleden lévő kártya <b>metamorfozeál</b> (2). <b>Felhúzás:</b> Készít a kezedbe egy <b>'Pikk dáma'</b> kártyát. <b>Kijátszásig:</b> Ha egy kártya a térfeleden <b>metamorfozeál</b>, drágább és erősebb lesz.", 7, 5, 5, SzaszLevente, 5, 5, "character", SzaszLeventeGacha, "SzaszLeventeCard", gachaPHAudio, "", [],["fiú", "diák", "reálos", "öreg ságváris"]);
    ...
    export let SarkanytojasCard = new diakCards("Sárkánytojás","","","summon","EmptyAbility", "<b>Idézés:</b> 2 kör után átváltozik <b>'Charmander'</b>-ré.", 0, 10, 10, Sarkanytojas, 3, 2, "character", SarkanytojasGacha, "SarkanytojasCard", gachaPHAudio, "", [],[]);
    ...
    export let CharmanderCard = new diakCards("Charmander","lelkiismeretes","","summon","EmptyAbility", "<b>Idézés:</b> 2 kör után átváltozik <b>'Charmeleon'</b>-né. <b>Passzív:</b> Ha kijátszol egy varázsige kártyát, készít a kezedbe egy <b>'Charmander lángja'</b> kártyát.", 6, 7, 7, Charmander, 3, 4, "character", GachaPH, "CharmanderCard", gachaPHAudio, "", [],[]);
    export let CharmeleonCard = new diakCards("Charmeleon","","tövisesbőr","summon","EmptyAbility", "<b>Idézés:</b> 2 kör után átváltozik <b>'Charizard'</b>-dá. <b>Passzív:</b> Ha kijátszol egy varázsige kártyát, készít a kezedbe egy <b>'Charmeleon lángja'</b> kártyát.", 6, 11, 11, Charmeleon, 3, 6, "character", GachaPH, "CharmeleonCard", gachaPHAudio, "", [],[]);
